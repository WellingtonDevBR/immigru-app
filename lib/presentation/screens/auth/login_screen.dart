...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget _buildEmailLoginForm(BuildContext context, bool isDarkMode,
      Color primaryColor, AuthState state) {
  ...
  Widget _buildPhoneLoginButton(BuildContext context, bool isDarkMode,
      Color primaryColor, AuthState state) {
