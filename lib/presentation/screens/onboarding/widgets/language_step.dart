...
class _LanguageStepState extends State<LanguageStep> {
  ...
  final SaveUserLanguagesUseCase _saveUserLanguagesUseCase =
      di.sl<SaveUserLanguagesUseCase>();
  final GetUserLanguagesUseCase _getUserLanguagesUseCase =
      di.sl<GetUserLanguagesUseCase>(); // Added use case
    ...
    try {
      ...
      if (userLanguages.isNotEmpty) {
        ...
        final selectedLanguageIds =
            userLanguages.map((lang) => lang.id).toList();
                      ...
                      : filteredLanguages.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isSelected =
                                    _selectedLanguages.contains(lowerIsoCode);
                                ...
                                return AnimatedContainer(
                                  ...
                                  child: InkWell(
                                    onTap: () => _toggleLanguageSelection(
                                        language.isoCode),
                                    borderRadius: BorderRadius.circular(12),
                                    child: Padding(
