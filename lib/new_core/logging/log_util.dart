...
class LogUtil {
  ...
  static void network(String message, {LogLevel level = LogLevel.info, String? tag, Object? error, StackTrace? stackTrace}) {
    logger.network(message, level: level, tag: tag, error: error, stackTrace: stackTrace);
  }
  
  /// Log a structured event with parameters
  static void logEvent(String eventName, {Map<String, dynamic>? parameters, LogLevel level = LogLevel.info}) {
