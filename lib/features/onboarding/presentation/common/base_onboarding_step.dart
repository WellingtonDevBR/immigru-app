...
/// including access to the onboarding bloc and logging.
abstract class BaseOnboardingStepState<T extends BaseOnboardingStep> extends State<T> {
  ...
  void didChangeDependencies() {
    ...
    _logger = ServiceLocator.instance<LoggerInterface>(instanceName: 'onboarding_logger');
  }
