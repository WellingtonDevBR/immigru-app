create table public."PostComment" (
  ...
  "Depth" smallint not null default '1'::smallint,
  "RootCommentId" uuid null,
  ...
  constraint comments_root_comment_id_fkey foreign KEY ("RootCommentId") references "PostComment" ("Id") on delete CASCADE,
